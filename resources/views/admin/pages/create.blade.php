...
@section('breadcrumb')
    <a href="{{ route('admin.dashboard') }}">Админка</a><span>›</span><a href="{{ route('admin.pages.index') }}">Страницы</a><span>›</span><span>Добавить</span>
@endsection
        ...
        <details class="admin-spoiler">
            ...
            <div class="admin-spoiler-body">
                ...
                <div class="admin-form-group">
                    ...
                    <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="{title}">
                </div>
                <div class="admin-form-group">
