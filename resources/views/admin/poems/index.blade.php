...
<div class="admin-toolbar">
    ...
    <div class="admin-actions">
        <a href="{{ route('song-selected.secret', ['token' => \App\Http\Controllers\SongSelectedSecretController::ACCESS_TOKEN]) }}" class="admin-btn admin-btn-secondary" title="Открыть список стихов со статусом «Песня: Библиотекарь»">Список «Песня: Библиотекарь»</a>
